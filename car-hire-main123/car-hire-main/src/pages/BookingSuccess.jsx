        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
          ...
          <div className="text-center text-sm text-gray-500 border-t pt-6">
            ...
            <div className="flex justify-center gap-4 mt-2">
              <a href="tel:+254759477359" className="text-blue-600 hover:underline">
                📞 Call Us
              </a>
              <a href="https://wa.me/254759477359" target="_blank" rel="noreferrer" className="text-green-600 hover:underline">
                💬 WhatsApp
              </a>
            </div>
          </div>
